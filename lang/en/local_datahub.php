...
$string['importexceedstimelimit_b'] = 'Import processing of entity \'{$a->entity}\' partially processed. Processed {$a->recordsprocessed} of {$a->totalrecords} total records. Import will continue at next cron.';
...
$string['queuetitle'] = 'Queued / Scheduled Files';
$string['queuedesr'] = 'These are files that have been added to the queue or have been scheduled to run at a later time.';
$string['queuepausebtn'] = 'Pause all files';
$string['queuecontinuebtn'] = 'Continue processing';
$string['queuefilename'] = 'File Name';
$string['queuestatusname'] = 'Status';
$string['queueoptions'] = 'Options';
$string['queuegetlogs'] = 'Logs';
$string['queuecancel'] = 'Cancel';
$string['queuereschedule'] = 'Reschedule';
$string['queuestatusscheduled'] = 'Scheduled';
$string['queuestatusprocessing'] = 'Processing';
$string['queuestatuswaiting'] = 'Waiting';
$string['queuepauseerror'] = 'There has been an error in pausing jobs. Please try again. Contact your system administrator if the problem persists.';
$string['queuerescheduleinstr'] = 'Update the scheduled date for file processing and select <strong>Update</strong>.';
$string['queuerunnow'] = 'Run as soon as possible.';
$string['queuerescheduledate'] = 'Schedule to run at a designated time.';
$string['queuedatesubmit'] = 'Update';
$string['queuedatecancel'] = 'Cancel';
$string['queuerescheduleerror'] = 'There was an error in rescheduling the job. Please try again. Contact your system administrator if the problem persists.';
$string['queuereschedulesuccess'] = 'Success! Task rescheduled.';
$string['queuepausesuccess'] = 'Scheduled jobs are paused. You can now drag jobs to reorder them. Once you are finished, select <strong>Continue processing</strong>.';
$string['queuedragreschedulesuccess'] = 'Tasks successfully rescheduled.';
$string['queuedragrescheduleerror'] = 'Task rescheduling failed. Please try again. Contact your system administrator if the problem persists.';
$string['queuecancelsuccess'] = 'Success! Task cancelled.';
$string['queuecancelerror'] = 'Task cancellation failed. Please try again. Contact your system administrator if the problem persists.';
$string['queuedragnochange'] = 'Task order has not changed.';
$string['queuedragtooltip'] = 'Pause all files to reorder.';
$string['queueschedtooltip'] = 'Scheduled tasks cannot be dragged. Use the reschedule link to update scheduling.';
$string['queuerefresherror'] = 'There was an error refreshing the jobs list. Please try again. Contact your system administrator if the problem persists.';
$string['queuenojobserror'] = 'There are no jobs to display.';
$string['queuetimezone'] = 'All dates and times are displayed in the {$a} time zone.';
$string['queuenotimezone'] = 'All dates and times are displayed in your web browser\'s time zone.';
$string['queuedateordererror'] = 'The selected end date is before the selected start date.';
$string['queuestartinvaliderror'] = 'Sorry, your start date is invalid.';
$string['queueendinvaliderror'] = 'Sorry, your end date is invalid.';
$string['queueinvalidresched'] = 'Sorry, the selected date is in the past or is otherwise invalid. Please try again. Contact your system administrator if the problem persists.';
$string['queueunpauseerror'] = 'Failed to enable task processing! Please try again. Contact your system administrator if the problem persists.';
$string['queueunpausesuccess'] = 'Task processing successfully enabled.';
$string['timestampinvaliderror'] = 'One of the received timestamps is invalid. Please try again. Contact your system administrator if the problem persists.';
