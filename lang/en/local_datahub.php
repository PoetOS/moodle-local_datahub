...
$string['importwarningconfirm'] = 'Got it. Take me to scheduling setup.';
$string['importwarningheader'] = 'Warning: Scheduled Task Recommended';
$string['importwarningcontent'] = 'The file you have selected to upload is too large for manual import. This data should be imported using the scheduled tasks interface.';
...
$string['rlip_form_dhexport_header'] = '<h2>Schedule DH job for: Export</h2>';
$string['rlip_form_dhimport_header'] = '<h2>Schedule DH job for: Import</h2>';
...
$string['schedule_step_title'] = '<b>Schedule DH job for: {$a}</b><br/><br/>2. Set when it runs';
$string['scheduled'] = 'scheduled';
$string['schedulepagetitle'] = 'Schedule DH';
$string['schedulingtime'] = "*Scheduled jobs may not run exactly at the specified time.";
$string['scheduling_labelstep'] = '1. Set the label';
...
$string['ws_user_create_partial_success_msg'] = 'User created with custom field errors - see logs for details.';
...
$string['ws_user_update_partial_success_msg'] = 'User updated with custom field errors - see logs for details.';
...
$string['ws_program_enrolment_create_success_msg'] = 'User successfully enrolled into Program';
...
$string['ws_program_enrolment_delete_success_msg'] = 'User successfully unenrolled from Program';
...
$string['ws_track_enrolment_create_success_msg'] = 'User successfully enrolled into track';
...
$string['ws_track_enrolment_delete_success_msg'] = 'User successfully unenrolled from track';
...
$string['ws_class_enrolment_create_success_msg'] = 'User successfully enrolled into Class';
...
$string['ws_class_enrolment_delete_success_msg'] = 'User successfully unenrolled from Class';
...
$string['ws_userset_enrolment_create_success_msg'] = 'User successfully enrolled into Userset';
...
$string['ws_userset_enrolment_delete_success_msg'] = 'User successfully unenrolled from Userset';
...
$string['ws_course_create_partial_success_msg'] = 'ELIS course description created with custom field errors - see logs for details.';
...
$string['ws_course_update_partial_success_msg'] = 'ELIS course description updated with custom field errors - see logs for details.';
...
$string['ws_class_create_partial_success_msg'] = 'Class created with custom field errors - see logs for details.';
...
$string['ws_class_update_partial_success_msg'] = 'Class updated with custom field errors - see logs for details.';
...
$string['ws_customfield_error'] = 'Invalid custom field value in WebServices API';
$string['ws_function_requires_elis'] = 'This webservices method requires ELIS. ELIS was not found. Cannot continue.';
$string['ws_program_create_partial_success_msg'] = 'Program created with custom field errors - see logs for details.';
...
$string['ws_program_update_partial_success_msg'] = 'Program updated with custom field errors - see logs for details.';
...
$string['ws_track_create_partial_success_msg'] = 'Track created with custom field errors - see logs for details.';
...
$string['ws_track_update_partial_success_msg'] = 'Track updated with custom field errors - see logs for details.';
...
$string['ws_userset_create_partial_success_msg'] = 'Userset created with custom field errors - see logs for details.';
...
$string['ws_userset_update_partial_success_msg'] = 'Userset updated with custom field errors - see logs for details.';
