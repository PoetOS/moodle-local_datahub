 ...
 */
class rlipimport_version2_importprovider_mock extends rlip_importprovider {
    /**
 ...
 */
class rlipimport_version2_importprovider_withname_mock extends rlip_importprovider {
    /**
     * @var array Fixed data to use as import data.
     */
    public $data;
...
class rlipimport_version2_importprovider_multi_mock extends rlip_importprovider {
    /**
     * @var array Fixed data to use as import data.
     */
    public $data;
 ...
 */
class rlipimport_version2_importprovider_mockenrolment extends rlipimport_version2_importprovider_mock {
}

/**
 * Class that fetches import files for the user import
 */
class rlipimport_version2_importprovider_mockuser extends rlipimport_version2_importprovider_mock {
}

/**
 * Class that fetches import files for the user import
 */
class rlipimport_version2_importprovider_createorupdateuser extends rlipimport_version2_importprovider_mock {
}

/**
 * Class that fetches import files for the course import
 */
class rlipimport_version2_importprovider_createorupdatecourse extends rlipimport_version2_importprovider_mock {
}

/**
 * Class that fetches import files for the enrolment import
 */
class rlipimport_version2_importprovider_createorupdateenrolment extends rlipimport_version2_importprovider_mock {
}
 ...
 * Class that fetches import files for the user import
 */
class rlipimport_version2_importprovider_emptyuser extends rlipimport_version2_importprovider_multi_mock {
 ...
 * Class that fetches import files for the course import
 */
class rlipimport_version2_importprovider_emptycourse extends rlipimport_version2_importprovider_multi_mock {
 ...
 * Class that fetches import files for the enrolment import
 */
class rlipimport_version2_importprovider_emptyenrolment extends rlipimport_version2_importprovider_multi_mock {
 ...
 * Class that fetches import files for the user import
 */
class rlipimport_version2_importprovider_loguser extends rlipimport_version2_importprovider_mock {
 ...
 * Class that fetches import files for the course import
 */
class rlipimport_version2_importprovider_logcourse extends rlipimport_version2_importprovider_mock {
 ...
 * Class that fetches import files for the course import
 */
class rlipimport_version2_importprovider_logenrolment extends rlipimport_version2_importprovider_mock {
}

/**
 * File plugin that reads from memory and reports a dynamic filename
 */
class rlip_version2_fileplugin_readmemory_dynamic extends rlip_fileplugin_readmemory {
 ...
 * import plugin
 */
class rlipimport_version2_importprovider_multiuser extends rlipimport_version2_importprovider_multi_mock {
}
 ...
 */
class rlipimport_version2_importprovider_loguser_dynamic extends rlipimport_version2_importprovider_loguser {
    public $data;
    public $filename;
    ...
    public function get_import_file($entity) {
        ...
        return new rlip_version2_fileplugin_readmemory_dynamic($rows, $this->filename);
    }
}

class rlipimport_version2_importprovider_file extends rlip_importprovider {
    public $filename;
...
class rlipimport_version2_importprovider_manual_delay extends rlip_importprovider_file_delay {
