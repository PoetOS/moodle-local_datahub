@local @local_datahub @dhimport_version2
Feature: Tabbed user interface
    ...
    Scenario: Navigate through version 2 UI tabs
        ...
        And I should see "Import" in the "ul.nav-tabs li a.active" "css_element"
        ...
        Then I should see "Data Hub Version 2" in the "//h2" "xpath_element"
        And I should see "Queue" in the "ul.nav-tabs li a.active" "css_element"
        ...
        Then I should see "Data Hub Version 2" in the "//h2" "xpath_element"
        And I should see "Settings" in the "ul.nav-tabs li a.active" "css_element"
