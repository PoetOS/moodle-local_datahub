...
$file = core_component::get_plugin_directory('dhimport', 'version2').'/version2.class.php';
require_once($file);


/**
 * Class for version 2 enrolment import correctness
 * @group local_datahub
 * @group dhimport_version2
 */
class version2enrolmentimport_testcase extends rlip_test {
    ...
    /**
     * Validate that the version 2 plugin supports enrolment actions
     */
    public function test_version2importsupportsenrolmentactions() {
        $supports = plugin_supports('dhimport', 'version2', 'enrolment');
        $this->assertEquals($supports, array('create', 'add', 'update', 'delete'));
    }

    /**
     * Validate that the version 2 plugin supports the enrolment create action
     */
    public function test_version2importsupportsenrolmentcreate() {
        $supports = plugin_supports('dhimport', 'version2', 'enrolment_create');
    ...
    /**
     * Validate that the version 2 plugin supports the enrolment add action
     */
    public function test_version2importsupportsenrolmentadd() {
        $supports = plugin_supports('dhimport', 'version2', 'enrolment_add');
        $requiredfields = array(
                array('username', 'email', 'idnumber'),
                'context',
                'instance',
    ...
    /**
     * Validate that the version 2 plugin supports the enrolment delete action
     */
    public function test_version2importsupportsenrolmentdelete() {
        $supports = plugin_supports('dhimport', 'version2', 'enrolment_delete');
        $requiredfields = array(
                array('username', 'email', 'idnumber'),
                'context',
                'instance',
    ...
    /**
     * Validate that the version 2 plugin supports the enrolment update action
     */
    public function test_version2importsupportsenrolmentupdate() {
        $supports = plugin_supports('dhimport', 'version2', 'enrolment_update');
        $requiredfields = array(
                array('username', 'email', 'idnumber'),
                'context',
                'instance'
     ...
     */
    public function test_version2importsetsrequiredcourseroleassignmentfieldsoncreate() {
        // Run the import.
     ...
     */
    public function test_version2importsetsrequiredsystemroleassignmentfieldsoncreate() {
        global $DB;
        // Run the import.
        $data = $this->get_core_enrolment_data();
        $data['context'] = 'system';
     ...
     */
    public function test_version2importsetsrequiredcoursecategoryroleassignmentfieldsoncreate() {
        global $DB;
     ...
     */
    public function test_version2importsetsrequireduserroleassignmentfieldsoncreate() {
        // Run the import.
        $data = $this->get_core_enrolment_data();
        $data['context'] = 'user';
     ...
     * @uses $DB
     */
    public function test_version2importsetsenrolmentandcompletetimeoncreate() {
        global $DB;
        $this->run_core_enrolment_import(array());
     ...
     */
    public function test_version2importpreventsinvalidenrolmentusernameoncreate() {
     ...
     */
    public function test_version2importpreventsinvalidenrolmentemailoncreate() {
     ...
     */
    public function test_version2importpreventsinvalidenrolmentidnumberoncreate() {
     ...
     */
    public function test_version2importpreventsinvalidcontextoncreate() {
     ...
     */
    public function test_version2importpreventsunassignablecontextoncreate() {
     ...
     */
    public function test_version2importpreventsinvalidcourseinstanceoncreate() {
     ...
     */
    public function test_version2importpreventsinvalidenrolmenttimeoncreate() {
     ...
     */
    public function test_version2importpreventsinvalidcompletetimeoncreate() {
     ...
     * role assignment creation
     */
    public function test_version2importpreventsinvalidcoursecategoryinstanceoncreate() {
        // Run the import.
        $data = $this->get_core_enrolment_data();
        $data['context'] = 'coursecat';
     ...
     * role assignment creation
     */
    public function test_version2importpreventsambiguouscoursecategoryinstanceoncreate() {
        // Run the import.
        $data = $this->get_core_enrolment_data();
        $data['context'] = 'coursecat';
     ...
     * role assignment creation
     */
    public function test_version2importpreventsinvaliduserinstanceoncreate() {
        // Setup.
     ...
     */
    public function test_version2importpreventsinvalidroleoncreate() {
     ...
     */
    public function test_version2importpreventssettingunsupportedenrolmentfieldsoncreate() {
        global $DB;
     ...
     * records on creation
     */
    public function test_version2importpreventsduplicateroleassignmentcreation() {
          global $DB;
     ...
     */
    public function test_version2importpreventsduplicateenrolmentcreation() {
        global $CFG, $DB;
     ...
     */
    public function test_version2importpreventsduplicateenrolmentandroleassignmentcreate() {
        global $CFG, $DB;
        require_once($CFG->dirroot.'/lib/enrollib.php');
     ...
     * appropriate
     */
    public function test_version2importenrolsappropriateuserasstudent() {
        global $DB;
     ...
     */
    public function test_version2importenrolupdate() {
        global $DB;
        ...
        $this->run_core_enrolment_import(['enrolmentaction' => 'update', 'status' => 'ACTIVE', 'role' => '']);
        $this->assert_record_exists('user_enrolments', [
            'userid' => self::$userid,
            'enrolid' => $enrolid,
            'timestart' => $timestart,
     ...
     * context
     */
    public function test_version2importenrolmentsarecoursecontextspecific() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin can create enrolments based on
     * username
     */
    public function test_version2importcreatesenrolmentbasedonusername() {
        // Run the import.
        $this->run_core_enrolment_import(array());
     ...
     * email
     */
    public function test_version2importcreatesenrolmentbasedonemail() {
        // Run the import.
     ...
     * idnumber
     */
    public function test_version2importcreatesenrolmentbasedonidnumber() {
        // Run the import.
        $data = array('entity' => 'enrolment',
                      'enrolmentaction' => 'create',
     ...
     * username and email
     */
    public function test_version2importcreatesenrolmentbasedonusernameemail() {
        // Run the import.
        $data = array('entity' => 'enrolment',
                      'enrolmentaction' => 'create',
                      'username' => 'rlipusername',
     ...
     */
    public function test_version2importcreatesenrolmentbasedonusernameidnumber() {
        // Run the import.
        $data = array('entity' => 'enrolment',
                      'enrolmentaction' => 'create',
                      'username' => 'rlipusername',
     ...
     * email and idnumber
     */
    public function test_version2importcreatesenrolmentbasedonemailidnumber() {
        // Run the import.
        $data = array('entity' => 'enrolment',
                      'enrolmentaction' => 'create',
                      'email' => 'rlipuser@rlipdomain.com',
     ...
     */
    public function test_version2importcreatesenrolmentbasedonusernameemailidnumber() {
        // Run the import.
        $data = array('entity' => 'enrolment',
                      'enrolmentaction' => 'create',
                      'username' => 'rlipusername',
    ...
    /**
     * Validate that the version 2 plugin does not created enrolments for
     * specified username if the specified email is incorrect
     */
    public function test_version2importdoesnotcreateenrolmentforvalidusernameinvalidemail() {
        $this->run_core_enrolment_import(array('email' => 'bogususer@bogusdomain.com'));
        $this->assert_no_role_assignments_exist();
    }
     ...
     */
    public function test_version2importdoesnotcreateenrolmentforvalidusernameinvalididnumber() {
        $this->run_core_enrolment_import(array('idnumber' => 'bogusidnumber'));
        $this->assert_no_role_assignments_exist();
    }
     ...
     */
    public function test_version2importdoesnotcreateenrolmentforvalidemailinvalidusername() {
     ...
     */
    public function test_version2importdoesnotcreateenrolmentforvalidemailinvalididnumber() {
        $this->run_core_enrolment_import(array('email' => 'rlipuser@rlipdomain.com',
     ...
     */
    public function test_version2importdoesnotcreateenrolmentforvalididnumberinvalidusername() {
     ...
     */
    public function test_version2importdoesnotcreateenrolmentforvalididnumberinvalidemail() {
        $this->run_core_enrolment_import(array('idnumber' => 'rlipidnumber',
     ...
     */
    public function test_version2importenrolsuseralreadyassignedarole() {
        global $DB;
     ...
     */
    public function test_version2importroleassignsalreadyenrolleduser() {
        global $DB;
     ...
     */
    public function test_version2importroleerrorpreventsenrolment() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin can create a group and assign a
     * user to it
     */
    public function test_version2importassignsusertocreatedgroup() {
        global $DB;

        // Enable group / grouping creation.
        set_config('creategroupsandgroupings', 1, 'dhimport_version2');
    ...
    /**
     * Validate that the version 2 plugin can assign a user to an existing
     * group
     */
    public function test_version2importassignsusertoexistinggroup() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin can create a group and a grouping,
     * and assign the group to the grouping
     */
    public function test_version2importassignsgreatedgrouptocreatedgrouping() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin can create a grouping and assign an
     * existing group to it
     */
    public function test_version2importassignsexistinggrouptocreatedgrouping() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin can create a group and assign it
     * to an existing grouping
     */
    public function test_version2importassignscreatedgrouptoexistinggrouping() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin can assign an existing group to an
     * existing grouping
     */
    public function test_version2importassignsexistinggrouptoexistinggrouping() {
        global $DB;
     ...
     */
    public function test_version2importroleerrorpreventsgroups() {
        global $DB;
     ...
     */
    public function test_version2importduplicateroleassignmentpreventsgroups() {
        global $DB;
     ...
     */
    public function test_version2importambiguousgroupnamepreventsenrolment() {
     ...
     */
    public function test_version2importinvalidgroupnamepreventsenrolment() {
        // Disable group / grouping creation.
        set_config('creategroupsandgroupings', 0, 'dhimport_version2');
     ...
     */
    public function test_version2importallowsduplicategroupnamesacrosscourses() {
        global $DB;
     ...
     */
    public function test_version2importallowsduplicategroupnamesinanothercourse() {
        global $DB;
     ...
     */
    public function test_version2importgroupsarecoursecontextspecific() {
        global $DB;
     ...
     */
    public function test_version2importambiguousgroupingnamepreventsenrolments() {
     ...
     */
    public function test_version2importinvalidgroupingnamepreventsenrolment() {
        // Disable group / grouping creation.
        set_config('creategroupsandgroupings', 0, 'dhimport_version2');
     ...
     */
    public function test_version2importallowsduplicategroupingnamesacrosscourses() {
        global $DB;
     ...
     */
    public function test_version2importallowsduplicategroupingnamesinanothercourse() {
        global $DB;
     ...
     * twice
     */
    public function test_version2importpreventsduplicateusergroupassignments() {
        global $CFG, $DB;
        require_once($CFG->dirroot.'/group/lib.php');
     ...
     * twice
     */
    public function test_version2importpreventsduplicategroupgroupingassignments() {
        global $CFG, $DB;
        require_once($CFG->dirroot.'/group/lib.php');
     ...
     */
    public function test_version2importonlysupportsgroupsforcoursecontext() {
        global $DB;
     ...
     * enabled
     */
    public function test_version2importonlycreatesgroupwithsettingenabled() {
        global $DB;
     ...
     * enabled
     */
    public function test_version2importonlycreatesgroupingwithsettingenabled() {
        global $DB;
     ...
     */
    public function test_version2importsetsenrolmenttimestamps() {
        global $CFG, $DB;
        require_once($CFG->dirroot.'/course/lib.php');
    ...
    /**
     * Validate that the version 2 plugin can delete enrolments based on username,
     * along with required non-user fields
     */
    public function test_version2importdeletesenrolmentbasedonusername() {
        // Set up our enrolment.
        $this->run_core_enrolment_import($this->get_core_enrolment_data(), false);

        // Perform the delete action.
        $data = $this->get_core_enrolment_data();
        $data['enrolmentaction'] = 'delete';
    ...
    /**
     * Validate that the version 2 plugin can delete enrolments based on email,
     * along with required non-user fields
     */
    public function test_version2importdeletesenrolmentbasedonemail() {
        // Set up our enrolment.
        $this->run_core_enrolment_import($this->get_core_enrolment_data(), false);
    ...
    /**
     * Validate that the version 2 plugin can delete enrolments based on idnumber,
     * along with required non-user fields
     */
    public function test_version2importdeletesenrolmentbasedonidnumber() {
        // Set up our enrolment.
        $this->run_core_enrolment_import($this->get_core_enrolment_data(), false);
     ...
     * along with required non-user fields
     */
    public function test_version2importdeletesenrolmentbasedonusernameemail() {
        // Set up our enrolment.
        $this->run_core_enrolment_import($this->get_core_enrolment_data(), false);
     ...
     */
    public function test_version2importdeletesenrolmentbasedonusernameidnumber() {
        // Set up our enrolment.
        $this->run_core_enrolment_import($this->get_core_enrolment_data(), false);
     ...
     * and idnumber, along with required non-user fields
     */
    public function test_version2importdeletesenrolmentbasedonemailidnumber() {
        // Set up our enrolment.
        $this->run_core_enrolment_import($this->get_core_enrolment_data(), false);
     ...
     */
    public function test_version2importdeletesenrolmentbasedonusernameemailidnumber() {
        // Set up our enrolment.
        $this->run_core_enrolment_import($this->get_core_enrolment_data(), false);
    ...
    /**
     * Validate that the version 2 plugin can delete an enrolment when there
     * is no role assignment tied to it
     */
    public function test_version2importdeletesenrolment() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin can delete a course-level role
     * assignment when there is no enrolment tied to it
     */
    public function test_version2importdeletescourseroleassignment() {
        // Set up our enrolment.
        $coursecontext = context_course::instance(self::$courseid);
        role_assign(self::$courseroleid, self::$userid, $coursecontext->id);
    ...
    /**
     * Validate that the version 2 plugin can delete an enrolment and role
     * assignment at the same time
     */
    public function test_version2importdeletesenrolmentandcourseroleassignment() {
        // Set up our enrolment.
        $this->run_core_enrolment_import(array());
    ...
    /**
     * Validate that the version 2 plugin can delete a system-level role
     * assignment
     */
    public function test_version2importdeletessystemroleassignment() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin can delete a category-level role
     * assignment
     */
    public function test_version2importdeletescoursecategoryroleassignment() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin can delete a user-level role
     * assignment
     */
    public function test_version2importdeletesuserroleassignment() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin does not delete enrolments when the
     * specified username is incorrect
     */
    public function test_version2importdoesnotdeleteenrolmentwithinvalidusername() {
        // Set up our enrolment.
        $data = $this->get_core_enrolment_data();
        $this->run_core_enrolment_import($data, false);
     ...
     */
    public function test_version2importdoesnotdeleteenrolmentwithinvalidemail() {
        // Set up our enrolment.
        $data = $this->get_core_enrolment_data();
        $this->run_core_enrolment_import($data, false);
     ...
     */
    public function test_version2importdoesnotdeleteenrolmentwithinvalididnumber() {
        // Set up our enrolment.
        $data = $this->get_core_enrolment_data();
        $this->run_core_enrolment_import($data, false);
     ...
     */
    public function test_version2importdoesnotdeleteenrolmentwithinvalidcontext() {
        // Set up our enrolment.
        $this->run_core_enrolment_import(array());
    ...
    /**
     * Validate that the version 2 plugin does not delete course-level role
     * assignments when the specified instance is incorrect
     */
    public function test_version2importdoesnotdeletecourseroleassignmentwithinvalidinstance() {
        // Set up our enrolment.
        $this->run_core_enrolment_import(array());
    ...
    /**
     * Validate that the version 2 plugin does not delete category-level role
     * assignments when the specified instance is incorrect
     */
    public function test_version2importdoesnotdeletecoursecategoryroleassignmentwithinvalidinstance() {
        global $DB;
     ...
     */
    public function test_version2importdoesnotdeletecoursecategoryroleassignmentwithambiguousinstance() {
        global $DB;
    ...
    /**
     * Validate that the version 2 plugin does not delete user-level role
     * assignments when the specified instance is incorrect
     */
    public function test_version2importdoesnotdeleteuserroleassignmentwithinvalidinstance() {
        global $DB;
     ...
     */
    public function test_version2importdoesnotdeleteenrolmentwithinvalidrole() {
        // Set up our enrolment.
        $this->run_core_enrolment_import(array());
    ...
    /**
     * Validate that the version 2 plugin does not delete an enrolment with the
     * specified username if the specified email is incorrect
     */
    public function test_version2importdoesnotdeleteenrolmentwithvalidusernameinvalidemail() {
        // Set up our enrolment.
        $data = $this->get_core_enrolment_data();
        $this->run_core_enrolment_import($data, false);
     ...
     * specified username if the specified idnumber is incorrect
     */
    public function test_version2importdoesnotdeleteenrolmentwithvalidusernameinvalididnumber() {
        // Set up our enrolment.
        $data = $this->get_core_enrolment_data();
        $this->run_core_enrolment_import($data, false);
     ...
     * specified email if the specified username is incorrect
     */
    public function test_version2importdoesnotdeleteenrolmentwithvalidemailinvalidusername() {
        // Set up our enrolment.
        $data = $this->get_core_enrolment_data();
        $this->run_core_enrolment_import($data, false);
     ...
     * specified email if the specified idnumber is incorrect
     */
    public function test_version2importdoesnotdeleteenrolmentwithvalidemailinvalididnumber() {
        // Set up our enrolment.
        $data = $this->get_core_enrolment_data();
        $this->run_core_enrolment_import($data, false);
     ...
     * specified idnumber if the specified username is incorrect
     */
    public function test_version2importdoesnotdeleteenrolmentwithvalididnumberinvalidusername() {
        // Set up our enrolment.
        $data = $this->get_core_enrolment_data();
        $this->run_core_enrolment_import($data, false);
     ...
     * specified idnumber if the specified email is incorrect
     */
    public function test_version2importdoesnotdeleteenrolmentwithvalididnumberinvalidemail() {
        // Set up our enrolment.
        $data = $this->get_core_enrolment_data();
        $this->run_core_enrolment_import($data, false);
    ...
    /**
     * Validate that the version 2 import plugin handles deletion of
     * non-existent enrolments gracefully
     */
    public function test_version2importpreventsnonexistentroleassignmentdeletion() {
        global $DB;
     ...
     */
    public function test_version2importroleerrorpreventsenrolmentdeletion() {
        global $DB;
     ...
     * on that same entity)
     */
    public function test_version2importenrolmentdeletionisrolespecific() {
        global $DB;
     ...
     */
    public function test_version2importusesenrolmentfieldmappings() {
        global $CFG, $DB;
        ...
        $DB->delete_records(RLIPIMPORT_VERSION2_MAPPING_TABLE);
     ...
     * maximum sizes
     */
    public function test_version2importsucceedswithmaxlengthenrolmentfields() {
        global $DB;
     ...
     */
    public function test_version2importnewenrolmentemail() {
        ...
        $importplugin = new rlip_importplugin_version2_enrolmententity_fakeemail('test');
        ...
        set_config('newenrolmentemailenabled', '0', 'dhimport_version2');
        set_config('newenrolmentemailsubject', 'Test Subject', 'dhimport_version2');
        set_config('newenrolmentemailtemplate', 'Test Body', 'dhimport_version2');
        set_config('newenrolmentemailfrom', 'teacher', 'dhimport_version2');
        $result = $importplugin->newenrolmentemail($user->id, $course->id);
        $this->assertFalse($result);

        // Test false return when enabled but empty template.
        set_config('newenrolmentemailenabled', '1', 'dhimport_version2');
        set_config('newenrolmentemailsubject', 'Test Subject', 'dhimport_version2');
        set_config('newenrolmentemailtemplate', '', 'dhimport_version2');
        set_config('newenrolmentemailfrom', 'teacher', 'dhimport_version2');
        $result = $importplugin->newenrolmentemail($user->id, $course->id);
        $this->assertFalse($result);
        ...
        $testbody = 'Test Body';
        set_config('newenrolmentemailenabled', '1', 'dhimport_version2');
        set_config('newenrolmentemailsubject', $testsubject, 'dhimport_version2');
        set_config('newenrolmentemailtemplate', $testbody, 'dhimport_version2');
        set_config('newenrolmentemailfrom', 'admin', 'dhimport_version2');
        $result = $importplugin->newenrolmentemail($user->id, $course->id);
     ...
     */
    public function test_version2importnewenrolmentemailgenerate() {
